...
parser.add_argument("--train_user_profiles_id", type=str)

# Hyperparamètres
parser.add_argument("--rating_col", type=str)
parser.add_argument("--num_vars_scale", type=float)
parser.add_argument("--cat_vars_scale", type=float)
...
train_user_profiles = Dataset.get_by_id(ws, id=args.train_user_profiles_id).to_pandas_dataframe()
...
model = ContentBasedRecommender(
    ...
    num_vars_scale=args.num_vars_scale,
    cat_vars_scale=args.cat_vars_scale
)
